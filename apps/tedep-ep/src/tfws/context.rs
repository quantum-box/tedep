...
use super::{config::TerraformWorkspaceConfig, TerraformWorkspace};
...
impl Context for TerraformWorkspaceContext {
    ...
    fn with_configs(
        ...
        Self {
            client: client.clone(),
            namespace_str: global_config.namespace_str().to_owned(),
            reconcile_interval: global_config.reconcile_interval(),
    ...
    fn resource_kind(&self) -> Cow<str> {
        <TerraformWorkspace as kube::Resource>::kind(&self.dynamic_type)
    }
